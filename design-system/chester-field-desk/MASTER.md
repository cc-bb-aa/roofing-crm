...
**Project:** Chester Field Desk
**Generated:** 2026-08-12 21:36:41
**Category:** CRM & Client Management
**Design Dials:** Variance 6/10 (Balanced / Modern) | Motion 3/10 (Subtle) | Density 8/10 (Dense / Dashboard)

> **Application remap:** The generated navy + sky + Fira Code system is kept below as the database baseline. The live CRM uses `pages/lead-map.md` (survey mylar, copper flashing, Barlow Condensed). Do not implement MASTER colors/fonts on the lead map.
